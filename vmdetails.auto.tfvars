...
vmid = 0  # VM ID (Default is 0 - Terraform will set this)
description = "Terraform Test VM" # Description of VM (Default is Terraform Test VM) Using Markdown if necessary
